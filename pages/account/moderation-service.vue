<template>
  <div v-if="checkAccess">
    ...
    <div class="row">
      ...
      >
        <div class="card-wrap">
          <div class="row" v-if="el.offerData">
            <div class="col-6 my-5">Тип объявления:</div>
            <div class="col-6 my-5">{{ el.offerData.specialization }}</div>
            <div class="col-6 my-5">Опыт работы:</div>
            <div class="col-6 my-5">{{ el.offerData.workDate }}</div>
            ...
            <div class="col px-10">
              <div
                ...
                @click="
                  openOffer(
                    'photos',
                    el.offerData.listPhotos,
                    el.offerData.specialization
                  )
                "
              >
                Фотографии
        ...
        <div v-if="el.offerData.listPhotos.length > 0">
            ...
            <div class="container">
              ...
              <div class="card-wrap">
                <div class="row">
                  <div
                    class="p-10"
                    v-for="(lP, i) in offerData.listPhotos"
                    :key="i"
                  >
                    <el-image
                      draggable="false"
...
export default {
  ...
  methods: {
    ...
    openOffer(type, data, title) {
      ...
      if (type === "photos") {
        this.offerData.listPhotos = data;
