  ...
  <div class="pb-100">
    ...
    <div ref="inputs">
      ...
      <div class="card-wrap mt-50">
        <h4>Об объекте</h4>
        <div class="row">
          <div class="col-md-6 d-flex align-items-center my-20">
            <div class="col-md-3 px-0">Общая площадь</div>
            <el-input class="col-md-6 px-0" type="text" />
          </div>
          <div class="col-md-6 d-flex align-items-center my-20">
            <div class="col-md-4 px-0">Количество комнат</div>
            <el-input class="col-md-6 px-0" type="text" />
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 d-flex align-items-center my-20">
            <div class="col-md-3 px-0">Этаж</div>
          ...
          <div class="col-md-6 d-flex align-items-center my-20">
            <div class="col-md-4 px-0">Этажей в доме</div>
            <div class="col-md-6 px-0">
              <el-input-number
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-center my-20">
            <div class="col-md-3 px-0">Тип застройки</div>
            <el-select
              placeholder=""
          ...
          <div class="col-md-6 d-flex align-items-center my-20">
            <div class="col-md-4 px-0">Ремонт</div>
            <el-select
              placeholder=""
